...
const SecurityBadge = ({ networkLocked }: SecurityBadgeProps) => (
  <div className="flex flex-none items-center gap-2 whitespace-nowrap rounded-full border border-grid bg-panel px-3 py-2 text-[11px] uppercase tracking-[0.2em] text-muted">
