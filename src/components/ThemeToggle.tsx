...
const ThemeToggle = ({ value, onChange }: ThemeToggleProps) => {
  ...
  return (
    <motion.button
      ...
      className="flex flex-none items-center gap-2 whitespace-nowrap rounded-full border border-grid bg-panel px-3 py-2 text-[11px] uppercase tracking-[0.3em] text-muted transition hover:text-text"
    >
